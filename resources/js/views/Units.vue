            ...
            <div class="d-block">
                <div class="form-group">
                    ...
                    <input
                        type="text"
                        :class="['form-control']"
                        placeholder="ex. kg or sq.ft or ltr"
                        v-model="unit.short_name"
                    />
                    <span v-if="errors.short_name" :class="['errorText']">{{
                        errors.short_name[0]
                    }}</span>
                </div>
                <div class="form-group">
                    ...
                    />
                    <span v-if="errors.long_name" :class="['errorText']">{{
                        errors.long_name[0]
                    }}</span>
                </div>
            </div>
                        ...
                        <tbody>
                            <tr v-for="unit in units" v-bind:key="unit.id">
                                ...
                                <td>
                                    ...
                                    >
                                        <span
                                            class="fa fa-edit custom_icon_table"
                                        ></span>
                                    </button>
                                    <button
                                    ...
                                    >
                                        <span
                                            class="fa fa-trash custom_icon_table"
                                        ></span>
                                    </button>
                                </td>
                            </tr>
    ...
    methods: {
            ...
            axios
                ...
                .then(response => {
                    ...
                    Vue.set(
                        this.unit,
                        "short_name",
                        response.data.unit.short_name
                    );
                    Vue.set(
                        this.unit,
                        "long_name",
                        response.data.unit.long_name
                    );
                ...
                if (result.value) {
                    axios
                        ...
                        .then(function(response) {
                            ...
                            let index_to_delete = currObj.units.findIndex(
                                unit => unit.id === id
                            );
        ...
        autoCompleteTable() {
            ...
            if (this.searchTableKey != "") {
                ...
                let currObj = this;
                axios
                    .post("/units/search", { searchQuery: this.searchTableKey })
                    .then(function(response) {
                        currObj.isLoading = "";
